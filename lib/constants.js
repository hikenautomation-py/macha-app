...
// Maks. golongan yang boleh diklaim sendiri saat pendaftaran (level pelaksana).
// Golongan 5-7 (SPV/ASM/SM) hanya bisa ditetapkan oleh atasan terverifikasi.
export const GOLONGAN_PELAKSANA_MAX = 4;

// Jabatan yang boleh dipilih saat pendaftaran (tanpa SPV/ASM/SM).
export const PELAKSANA_TITLE_OPTIONS = TITLE_OPTIONS.filter((t) => !ATASAN_TITLES.includes(t));

// URL web app produksi (dipakai di pesan bot & dokumentasi).
export const WEB_APP_URL = 'https://app.machapp.web.id';
